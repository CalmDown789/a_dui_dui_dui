...
200 MHz最高WNS仍为−0.162ns，尚未达到最低+0.100ns目标；V6功能回归完整通过，但布线WNS为−0.638ns，不采用。C继续使用本说明的150 MHz候选；150 MHz发布基点为`6cc8ea4173d2a720f741e80b7cbd9279558ee93a`。200实验只作后续优化记录，见[200 MHz收尾与下次交接](MEMBER_B_200MHZ_TIMING_2026-09-26.md)。
