...
// Member B 2026-09-26 experiment. For L5 only, a two-slot partial FIFO
...
module mac_issue_stage #(
    ...
    generate
        if ((K==5)&&(CIN==16)&&(COUT==4)) begin : g_l5_partial_buffer
            // Frozen L5 has OUT_PAR=4: 3-bit phase + 4 signed32 values = 131.
