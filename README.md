> **本分支入口（2026-09-25）**：`acx750-rtl` 是成员 B 的早期 ACX750
> RTL 原语验证分支，当前 B 代码与报告从 [`acx750_rtl/README.md`](acx750_rtl/README.md)
> 进入。下面的 PYNQ-Z2/HLS 十小时冲刺说明是分支建立前继承的历史文档，
> 原文和队友文件均保留；它不是当前 ACX750 五层网络的验收说明。
