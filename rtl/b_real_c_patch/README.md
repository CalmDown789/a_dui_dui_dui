...
- `phase_accumulator.sv` from `rtl/b_real_ae29515/stream/phase_accumulator.sv`, upstream commit `ae29515945fbb6e9566626d7f2d28660ac94d5c4`, SHA-256 `1f03bd32647f09585b7b7b6b371646eb4f9aff92f627c4caabd92d263d35c66c`.
- `prelu_requantize.sv` from `rtl/b_real_ae29515/postprocess/prelu_requantize.sv`, upstream commit `ae29515945fbb6e9566626d7f2d28660ac94d5c4`, SHA-256 `7f4f21ce208ae9489088bf856dada8cdd8f675352a993b4ff02f52e5205bcff1`.
...
The requantizer splits Q1.15 rounding/saturation and Q31 multiply from the
final Q31 rounding/saturation stages. The accumulator override registers each
completed 48-bit phase sum before adding the bias and saturating to INT32. Both
changes add elastic latency only; arithmetic, phase order, and output
backpressure behavior remain unchanged.
...
path. `scripts/run_sim.tcl` and `scripts/synth_bc_real.tcl` both use these four
files so simulation and synthesis exercise the same implementation.
