...
// Row-major flattened 5x5 signed dot product.
module dot25_pipeline #(
    ...
    input  wire                              rst,
    input  wire                              in_valid,
    input  wire signed [(25*ACT_W)-1:0]      x_flat,
    ...
    localparam integer DOT_W = PROD_W + 5;
    ...
    generate
        for (product_index=0; product_index<25; product_index=product_index+1) begin : g_mult
            dsp_signed_mult #(
                ...
                .a(x_flat[(product_index*ACT_W) +: ACT_W]),
                .b(k_flat[(product_index*WGT_W) +: WGT_W]),
