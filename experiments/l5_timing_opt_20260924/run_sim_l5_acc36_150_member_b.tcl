# Member B exact 150 MHz ram-decomp source overlay regression.
...
set timing_opt_dir "$root_dir/experiments/l5_timing_opt_20260924"
set rtl_dir    "$root_dir/rtl"
set tb_dir     "$root_dir/tb"
set sim_root   "$root_dir/_sim_l5_member_b_acc36_wrptrlocal150"
...
set rtl_files [list \
    ...
    "$member_b_overlay_dir/rtl/c_ramdecomp_member_b/stripe_buffer.v" \
    ...
    "$member_b_overlay_dir/rtl/c_150_member_b/c_top.v"         \
    "$member_b_overlay_dir/rtl/c_150_member_b/c_synth_top.v"   \
...
set rf [open "$root_dir/report/sim_result_l5_member_b_acc36_wrptrlocal150.txt" w]
puts $rf "=============================================="
...
if {[llength $all_tbs] == 1} {
    ...
    file copy -force "$root_dir/report/sim_result_l5_member_b_acc36_wrptrlocal150.txt" "$root_dir/report/sim_result_l5_member_b_acc36_wrptrlocal150_${one_tb}.txt"
}

puts ""
puts " -> $root_dir/report/sim_result_l5_member_b_acc36_wrptrlocal150.txt"
