...
set do_impl 0
set variant "l5splitmem_realrom_150_member_b_wrptrlocal_netdelay"
if {[info exists argv] && [lsearch -exact $argv "acc36"] >= 0} { set variant "acc36_realrom_150_member_b_wrptrlocal_netdelay" }
...
set fifo_file "$timing_opt_dir/rtl/b/elastic_fifo.sv"
