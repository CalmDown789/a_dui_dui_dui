...
set sim_root   "$root_dir/_sim_l5_member_b_acc36_pow2ptr150"
...
set b_real_files [list \
    ...
    "$timing_opt_dir/rtl/b/elastic_fifo_pow2.sv"                 \
...
set rf [open "$root_dir/report/sim_result_l5_member_b_acc36_pow2ptr150.txt" w]
puts $rf "=============================================="
...
if {[llength $all_tbs] == 1} {
    ...
    file copy -force "$root_dir/report/sim_result_l5_member_b_acc36_pow2ptr150.txt" "$root_dir/report/sim_result_l5_member_b_acc36_pow2ptr150_${one_tb}.txt"
}

puts ""
puts " -> $root_dir/report/sim_result_l5_member_b_acc36_pow2ptr150.txt"
