...
set do_impl 0
set variant "l5splitmem_realrom_200_member_b_setup0300926"
if {[info exists argv] && [lsearch -exact $argv "acc36"] >= 0} { set variant "acc36_realrom_200_member_b_setup0300926" }
...
puts "MARGIN200_SETUP030_COMPLETE"
