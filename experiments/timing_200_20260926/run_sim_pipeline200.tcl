...
# Isolated 200 MHz early-bias, L5 buffer, stripe read and Q31 product pipeline.
...
set sim_root   "$root_dir/_sim_l5_member_b_acc36_pipeline200"
set pipeline_tag "pipeline200"
...
set rtl_files [list \
    ...
    "$script_dir/stripe_pipe/stripe_buffer.v" \
...
set b_real_files [list \
    ...
    $pipeline_fifo_file                 \
    "$script_dir/mac_buffer/mac_issue_stage.sv"              \
...
puts "MARGIN200_PIPELINE_REGRESSION_COMPLETE"
