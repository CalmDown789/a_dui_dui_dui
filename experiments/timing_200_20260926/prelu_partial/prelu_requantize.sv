...
// Isolated nine-cycle scalar candidate: two registered 16-bit partial products
// followed by a fabric reconstruction adder and a complete signed48 register.
// x = signed(x[31:16])*65536 + unsigned(x[15:0]). Each partial multiply fits
// one DSP multiplier; the final sum must remain outside the DSP cascade.
