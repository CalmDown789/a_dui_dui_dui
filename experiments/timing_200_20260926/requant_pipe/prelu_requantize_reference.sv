...
module prelu_requantize_reference #(
    ...
    wire signed [48:0] prelu_product_extended_s1 =
        {prelu_product_s1[47],prelu_product_s1};
    ...
    reg valid_s5;
    wire signed [32:0] requant_trunc_s5 = $signed(requant_product_s5[63:31]);
    wire requant_round_up_s5 =
        requant_product_s5[30] & (~requant_product_s5[63] | (|requant_product_s5[29:0]));
    wire signed [33:0] requant_rounded_s5 =
        $signed({requant_trunc_s5[32], requant_trunc_s5}) + $signed({33'd0, requant_round_up_s5});
    reg signed [33:0] rounded_q31_s6;
    reg valid_s6;
    ...
    always @(posedge clk) begin
        if (rst) begin
            ...
            if (valid_s5)
                rounded_q31_s6 <= requant_rounded_s5;
            valid_s6 <= valid_s5;
        end
    end
    ...
    always @(posedge clk) begin
        if (rst) begin
            ...
            if (valid_s6)
                out_data <= saturate_q31_output(rounded_q31_s6);
            out_valid <= valid_s6;
        end
    end
