# Isolated stripe read-pipeline simulation; no synthesis or implementation.
# Run under the intended Vivado environment. No fallback to another version.
# Optional -tclargs: tb_stripe_pipe tb_stripe_buffer tb_backpressure_rand
