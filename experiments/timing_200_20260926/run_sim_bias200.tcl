# Member B: isolated 200 MHz bias-early regression, no baseline sources changed.
...
set sim_root   "$root_dir/_sim_l5_member_b_acc36_bias200"
...
set rf [open "$root_dir/report/sim_result_l5_member_b_acc36_bias200.txt" w]
puts $rf "=============================================="
...
if {[llength $all_tbs] == 1} {
    ...
    file copy -force "$root_dir/report/sim_result_l5_member_b_acc36_bias200.txt" "$root_dir/report/sim_result_l5_member_b_acc36_bias200_${one_tb}.txt"
}

puts ""
puts " -> $root_dir/report/sim_result_l5_member_b_acc36_bias200.txt"
