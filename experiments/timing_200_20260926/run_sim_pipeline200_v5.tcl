...
# V5: early bias, L3/L5 partial buffers, explicit stripe banks, fixed-tap
...
set sim_root   "$root_dir/_sim_l5_member_b_acc36_pipeline200_v5"
set pipeline_tag "pipeline200_v5"
...
foreach tb $all_tbs {
    ...
    set bkind  "REAL V5 (early bias, L3/L5 buffer, banked stripe, shifted post slots, Q31 register)"
...
puts $rf "11  candidate        : V5 mac_buffer_l3l5 + post_shift + stripe_banked"
puts $rf "----------------------------------------------"
foreach tb $all_tbs {
...
puts "MARGIN200_PIPELINE_V5_REGRESSION_COMPLETE tag=$pipeline_tag"
