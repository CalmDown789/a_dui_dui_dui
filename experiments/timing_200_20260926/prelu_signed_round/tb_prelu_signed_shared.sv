...
module post_shift_case #(
    ...
    initial begin
        ...
        $display("PRELU_SIGNED_SHARED_CONFIG_PASS id=%0d channels=%0d lanes=%0d signed=%0d prelu=%0d inputs=%0d outputs=%0d in_stall=%0d out_stall=%0d simultaneous_io=%0d capture_issue=%0d slot0=%0d slot1=%0d groups=%0d gaps=%0d cycles=%0d",
...
module tb_prelu_signed_shared;
    ...
    initial begin
        ...
        $display("PRELU_SIGNED_SHARED_ALL_CONFIGS_PASS configs=5");
        $finish;
    end
    initial begin
        #500001;
