# V6 validation: explicit PReLU and Q31 partial products.
# Combined candidate regression. Real-B tests and C-shell tests are distinct.
# V6: early bias, L3/L5 partial buffers, explicit stripe banks, fixed-tap
...
set sim_root   "$root_dir/_sim_l5_member_b_acc36_pipeline200_v6"
set pipeline_tag "pipeline200_v6"
...
foreach tb $all_tbs {
    ...
    set bkind  "REAL V6 (PReLU/Q31 partial products, early bias, L3/L5 buffer, banked stripe)"
...
puts $rf "11  candidate        : V6 mac_buffer_l3l5 + post_partial32 + stripe_banked"
puts $rf "----------------------------------------------"
foreach tb $all_tbs {
...
puts "MARGIN200_PIPELINE_V6_REGRESSION_COMPLETE tag=$pipeline_tag"
