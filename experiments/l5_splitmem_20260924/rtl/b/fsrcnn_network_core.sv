...
module fsrcnn_network_core #(
    ...
    fsrcnn_stream_layer #(.IMG_W(IMG_W),.IMG_H(IMG_H),.K(5),.CIN(1),.COUT(16),
        .IN_PAR(1),.OUT_PAR(2),.ACT_W(8),.ACT_UNSIGNED(1),.OUT_W(16),.PIPE_SELECTED_OPERANDS(1)) l1 (
    ...
    fsrcnn_stream_layer #(.IMG_W(IMG_W),.IMG_H(IMG_H),.K(1),.CIN(16),.COUT(8),
        .IN_PAR(2),.OUT_PAR(8),.ACT_W(16),.ACT_UNSIGNED(0),.OUT_W(16),.PIPE_SELECTED_OPERANDS(1)) l2 (
    ...
    fsrcnn_stream_layer #(.IMG_W(IMG_W),.IMG_H(IMG_H),.K(3),.CIN(8),.COUT(8),
        .IN_PAR(1),.OUT_PAR(8),.ACT_W(16),.ACT_UNSIGNED(0),.OUT_W(16),.PIPE_SELECTED_OPERANDS(1)) l3 (
    ...
    fsrcnn_stream_layer #(.IMG_W(IMG_W),.IMG_H(IMG_H),.K(1),.CIN(8),.COUT(16),
        .IN_PAR(1),.OUT_PAR(16),.ACT_W(16),.ACT_UNSIGNED(0),.OUT_W(16),.PIPE_SELECTED_OPERANDS(1)) l4 (
    ...
    fsrcnn_stream_layer #(.IMG_W(IMG_W),.IMG_H(IMG_H),.K(5),.CIN(16),.COUT(4),
        .IN_PAR(2),.OUT_PAR(4),.ACT_W(16),.ACT_UNSIGNED(0),.OUT_W(8),.APPLY_PRELU(0),
        .PIPE_SELECTED_OPERANDS(1)) l5 (
