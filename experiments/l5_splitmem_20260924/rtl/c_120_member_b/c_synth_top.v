// 成员B工作：120 MHz fallback clock and 100 ms auto-start; copied from c-side-latest@6b87af3.
//=============================================================================
...
module c_synth_top (
    ...
    c_top #(
        ...
        .USE_MMCM       (1),
        .CLK_HZ         (120000000),       // 120 MHz
        //--- UART（v3.2.2 §五.7） -------------------------------------------
        .UART_BAUD      (`C_UART_BAUD),    // 921600
        .RB_ENABLE      (1),
        //--- 板级冒烟自动启动（真实 start 触发源尚未冻结） ------------------
        .AUTO_START_EN  (1),
        .AUTO_START_CYCLES (12_000_000)    // @120MHz ≈ 100 ms
    ) u_top (
        .sys_clk (sys_clk),
        .rst_n   (rst_n),
        .led     (led),
